...
const buttonVariants = cva("inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0", {
    variants: {
        ...
        size: {
            default: "h-9 px-4 py-2 hover:scale-110 active:scale-100",
            sm: "h-8 rounded-md px-3 text-xs hover:scale-125 active:scale-100",
            lg: "h-10 rounded-md px-8 hover:scale-105 active:scale-100",
            icon: "h-9 w-9",
        },
    },
    defaultVariants: {
...
const Button = r$1.forwardRef(({ className, variant, size, children, ...props }, ref) => {
    return (jsxRuntime.jsx("button", { className: cn(buttonVariants({ variant, size, className })), ref: ref, ...props, children: children }));
});
