...
import r$1, { useRef, useDebugValue, createElement, useContext } from 'react';
...
const Button = r$1.forwardRef(({ className, variant, size, children, ...props }, ref) => {
    return (jsx("button", { className: cn(buttonVariants({ variant, size, className })), ref: ref, ...props, children: children }));
});
